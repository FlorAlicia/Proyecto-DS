...
<div class="container mt-4 text-center">
    <div class="row d-flex align-items-center">
        <div class="col-md-4">
            <div class="btn-container">
                <a href="menuganado.php" class="btn btn-lg btn-secondary btn-white-border">
    ...
    <div class="row justify-content-center d-flex align-items-center">
        <div class="col-md-4">
            <div class="btn-container">
                <a href="empleados.php" class="btn btn-lg btn-secondary btn-white-border">
                    <img src="../images/empleados.jpg" alt="Empleados" class="img-fluid rounded" style="width: 220px;">
                </a>
        ...
        <div class="col-md-4">
            <div class="btn-container">
                <a href="ganaderos.php" class="btn btn-lg btn-secondary btn-white-border">
                    <img src="../images/ganaderoic.jpg" alt="Ganaderos" class="img-fluid rounded" style="width: 220px;">
                </a>
                <div class="btn-name">Ganaderos</div>
            </div>
        </div>
    </div>
</div>
